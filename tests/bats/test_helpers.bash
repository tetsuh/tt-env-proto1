...
make_fake_system_shim_commands() {
  ...
  for command_name in tt-smi tt-flash tt-topology tt-burnin tt-inference-server tt-metalium tt-metalium-ubuntu22 tt-metalium-ubuntu24 tt-metalium-models tt-studio; do
